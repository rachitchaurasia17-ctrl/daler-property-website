...
function BookingModal({ open, onClose }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setError("Could not reach the desk. Please call +91 98765 00007.");
    } finally {
      setSending(false);
    }
  };
    ...
    <>
      ...
      <div className={"bm-shell " + (open ? "open" : "")} role="dialog" aria-label="Schedule a viewing">
        <header className="bm-head">
          <div>
            <div className="bm-eyebrow"><span className="bm-rule"/>Daler Property · Reservation Desk</div>
        ...
        {sent ? (
          ...
          <form className="bm-grid" onSubmit={submit}>
            ...
            <aside className="bm-col bm-col-summary">
              ...
              <Row k="Office"   v="5055 Mohali Tower · Near Airport Road · Zirakpur · 140603" />
              ...
              <a href="tel:+919876500007" className="bm-call">Or call the desk · +91 98765 00007</a>
            </aside>
          </form>
        )}
      </div>
