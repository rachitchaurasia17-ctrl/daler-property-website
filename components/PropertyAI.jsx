...
const SYSTEM_PROMPT = `You are Property AI, the digital concierge for Daler Property — a trusted real estate agency in the Mohali tri-city (Mohali, Chandigarh, Zirakpur, Kharar, New Chandigarh).

Firm facts:
- Firm: Daler Property
- Office: 5055 Mohali Tower, Sector 79, Sahibzada Ajit Singh Nagar, Punjab 140308
...
function PropertyAI({ onSchedule }) {
  ...
  const send = async (text) => {
    ...
    try {
      ...
      setMessages((m) => [...m, { role: "assistant", content: "I can't reach my brain right now. Please call the desk on +91 98765 00007 — they'll be happy to help." }]);
    } finally {
      setSending(false);
    }
  };
